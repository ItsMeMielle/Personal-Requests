...
window.foundAliases = [];
if ($("#input").val() !== "package create" && $("#input").val !== "package download") gwc.output.append("Syntax is <package create/download>", msgColor);
if (args[1] === "package create") createPopup();
if (args[1] === "package download") {
